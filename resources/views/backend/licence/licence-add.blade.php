...
<div class="row mb-2" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 8px; background-color:#fff">
    <div class="col-sm-6">
        <h1 class="m-0">লাইসেন্স যুক্ত</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('licence')}}" class="btn btn-outline-success button btnfont">লাইসেন্স দেখুন</a></li>
        </ol>
    </div>
</div>
@endsection
    ...
    <div class="col-md-12 ">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <a class="h6 btnfon">লাইসেন্স যুক্ত</a>
            ...
            <div class="card-body">
                ...
                <form action="{{route('licence.save')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <input readonly type="hidden" id="kachariNo" name="kacari_no" class="kachariNonmer form-control">
                        <input readonly type="hidden" id="statioSerial" class="statioSerialnum form-control">
                        <input readonly type="hidden" id="licencetypeserial"  class="licencetypeserialnum form-control">
                        <input readonly type="hidden" id="lcserial" name="serial_no" class="form-control lcserialnum">
                        ...
                        <div class="col-md-2 my-2">
                            ...
                            <select name="licence_type_id" id="licencetype" value="{{ old('liceneType_id') }}" class="form-control selectfont select2bs4" id="">
                                ...
                                @forelse ($licenceTypes as $licenceType)
