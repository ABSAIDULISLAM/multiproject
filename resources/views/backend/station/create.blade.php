    ...
    <div class="col-md-10 m-auto ">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <a class="h6 btnfon">নতুন স্টেশন যুক্ত করুন</a>
                ...
                <form action="{{route('station.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4 my-2">
                            <label for="" class="inputcss" >স্টেশন নাম্বার</label>
                            <input type="number" readonly name="staion_serial" value="{{$serial}}" class="form-control" style="font-size: 13px">
                        </div>
                        ...
                        <div class="col-md-4 my-2">
                            <label for="" class="inputcss" >স্টেশন নাম লিখুন</label>
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" style="font-size: 13px" placeholder="স্টেশন নাম লিখুন ">
                        </div>
