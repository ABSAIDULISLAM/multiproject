...
<div class="row mb-2" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding: 8px; background-color:#fff">
    <div class="col-sm-6">
        <h1 class="m-0">উপজেলা যুক্ত </h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="#">উপজেলা যুক্ত </a></li>
        </ol>
    </div>
</div>
@endsection
    ...
    <div class="col-md-8 m-auto">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <a class="h6 btnfon">উপজেলা যুক্ত করুন</a>
                ...
                <form action="{{route('upzila.store')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 my-2">
                            ...
                            <select name="district_id" class="form-control selectfont select2bs4" id="">
                                    <option selected="selected" disabled>জেলা সিলেক্ট করুণ</option>
                        ...
                        <div class="col-md-6 my-2">
                            <label for="" class="inputcss" >উপজেলা লিখুন</label>
                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" style="font-size: 13px" placeholder="উপজেলা নাম লিখুন ">
                        </div>
